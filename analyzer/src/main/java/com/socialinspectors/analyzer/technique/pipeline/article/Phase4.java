...
public class Phase4 extends Phase {
	...
	private static final String PHASE4_TRAINING_DATA_CSV = "phase4_training_data.csv";
	...
	protected void execute() throws IOException {
		...
		writer = new BufferedWriter(new FileWriter(getCleanDataset(PHASE4_TRAINING_DATA_CSV)));
		String strLine;
