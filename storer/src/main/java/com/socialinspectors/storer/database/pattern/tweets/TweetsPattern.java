...
public abstract class TweetsPattern implements Pattern {
	...
	public TweetsPattern(String authorUserName, String authorScreenName,
			String authorUri, String authorPictureUri, String tweet,
	...
	protected Document getBaseDocument() {
		Document document = new Document()
				.append(TweetsPatternConstants.AUTHOR,
						new Document()
								.append(TweetsPatternConstants.USERNAME,
										authorUserName)
								.append(TweetsPatternConstants.URI, authorUri)
								.append(TweetsPatternConstants.SCREENNAME,
										authorScreenName)
								.append(TweetsPatternConstants.PROFILE_PICTURE,
										authorPictureUri))
				.append(TweetsPatternConstants.TWEET, tweet)
				.append(TweetsPatternConstants.URI, getTweetUri())
				.append(TweetsPatternConstants.LOCATION,
						new Document().append(TweetsPatternConstants.X,
								locationX).append(TweetsPatternConstants.Y,
								locationY))
				.append(TweetsPatternConstants.DATE, date)
				.append(TweetsPatternConstants.COUNTRY, country)
				.append(TweetsPatternConstants.CITY, city);
