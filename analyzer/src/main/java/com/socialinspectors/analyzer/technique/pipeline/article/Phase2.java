...
public class Phase2 extends Phase {
	private static final String PHASE2_TRAINING_DATA_CSV = "phase2_training_data.csv";
	...
	protected void execute() throws IOException {
		...
		writer = new BufferedWriter(new FileWriter(getCleanDataset(PHASE2_TRAINING_DATA_CSV)));
		String strLine;
