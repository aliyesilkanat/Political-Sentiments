...
public class AdjXOrVerbModelTrainer {
	private static final String TRAINED_MODEL = "labelled_sentences_adj_verb_training_data_2.csv";
	private static final String LABELLED_SENTENCES_TXT = "labelled_sentences.txt";
	private static final String[] VERBS = { "VB", "VBD", "VBG", "VBN", "VBP", "VBZ " };
	private static final Logger logger = LogManager.getLogger(AdjXOrVerbModelTrainer.class);
	...
	public static void main(String[] args) {
		try {
			new AdjXOrVerbModelTrainer().train();
		} catch (Exception e) {
	...
	private void train() throws Exception {
		...
		writer = new BufferedWriter(new FileWriter(TRAINED_MODEL));
		String strLine;
